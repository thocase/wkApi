...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2024-10-06 00:15:10',NULL),('diagnostics.include_raw','OFF','2024-10-06 00:15:10',NULL),('ps_thread_trx_info.max_length','65535','2024-10-06 00:15:10',NULL),('statement_performance_analyzer.limit','100','2024-10-06 00:15:10',NULL),('statement_performance_analyzer.view',NULL,'2024-10-06 00:15:10',NULL),('statement_truncate_len','64','2024-10-06 00:15:10',NULL);
...
--
-- Current Database: `bancowk`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `bancowk` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `produto` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_produto_categoria` (`id_produto_categoria`),
  CONSTRAINT `produto_ibfk_1` FOREIGN KEY (`id_produto_categoria`) REFERENCES `produtocategoria` (`id`)
...
INSERT INTO `produto` VALUES (2,'cadeira','cadeira',20.00,44,2),(4,'cadeira','cadeira',20.00,44,3),(8,'armario','armario',500.00,33,2),(9,'Notebook','Notebook',3000.00,1,8);
...
INSERT INTO `produtocategoria` VALUES (1,'Eletrônicos','Produtos eletrônicos como TVs, smartphones e computadores'),(2,'Móveis','Móveis de casa como mesas, cadeiras e sofás'),(3,'teste c','teste d'),(5,'nova categoria3','testea'),(8,'TI','TI');
/*!40000 ALTER TABLE `produtocategoria` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'bancowk'
--

--
-- Dumping routines for database 'bancowk'
--
...
-- Dump completed on 2024-10-06 21:02:27
